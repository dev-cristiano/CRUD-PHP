            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <button class="btn btn-success" type="button">
                        <a href="form_produto.php" style="color: #fff; text-decoration: none;"><i class="fa-solid fa-plus"></i> Novo</a>
                    </button>
                    ...
                    <table class="table table-hover table-sm">
                        ...
                        <tbody>
                            ...
                            while ($dados = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td scope='row'> R$" . number_format($preco_custo, 2, ',', '.') . "</td>";
                                echo "<td scope='row'> R$" . number_format($preco_compra, 2, ',', '.') . "</td>";
                                echo "<td scope='row'> R$" . number_format($preco_venda, 2, ',', '.') . "</td>";
                                echo "<td scope=''>

        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <button class="btn btn-success" type="button">
                    <a href="form_cliente.php" style="color: #fff; text-decoration: none;"><i class="fa-solid fa-plus"></i> Novo</a>
                </button>
                ...
                <hr>
                    <table class="table table-hover table-sm ">
                        ...
                        <?php
                            ...
                            {
                             echo "<tr>";
                             echo "<td scope='row'>".$dados['idcliente']."</td>";
                             echo "<td scope='row'>".$dados['nome']."</td>";
                             echo "<td scope='row'>".$dados['cpf']."</td>";
                             echo "<td scope='row'>".$dados['endereco']."</td>";  
                             echo "<td scope='row'>".$dados['telefone']."</td>";
                             echo "<td scope='row'>
                             <a class='btn btn-new' style='margin-left: 50%;' href='#'>
                             <i class='fa-solid fa-pen-to-square'></i></a>

                             <a class='btn btn-delete' href='./edit/delete-cliente.php?idcliente=$dados[idcliente]'>
